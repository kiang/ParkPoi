<div class="groupPermissions form">
    ...
    <fieldset>
        ...
        <?php
        echo '<div class="col clear">Parent</div>' . $this->Form->input('parent_id', array(
            'type' => 'select',
        ...
        echo '<div class="col clear">Name</div>' . $this->Form->input('name', array(
            'type' => 'text',
            'div' => 'span4',
            'class' => 'span4',
            'label' => false,
        ));
        echo '<div class="col clear">Description</div>' . $this->Form->input('description', array(
            'type' => 'text',
            'div' => 'span12',
            'class' => 'span12',
            'label' => false,
        ));
        echo '<div class="col clear">Order</div>' . $this->Form->input('order', array(
            'type' => 'text',
            'div' => 'span4',
            'class' => 'span4',
            'label' => false,
        ...
        echo '<div class="col clear">Acos</div>' . $this->Form->input('acos', array(
            'type' => 'textarea',
            'div' => 'span12',
            'class' => 'span12',
            'label' => false,
        ...
        echo '<div class="col">' . $this->Form->button('Push', array(
            'type' => 'button',
            'class' => 'span3',
            'id' => 'acoPush',
        )) . '</div>';
        echo '<div class="col">' . $this->Form->button('Clear', array(
            'type' => 'button',
            'class' => 'span3',
            'id' => 'acoClear',
        )) . '</div>';
