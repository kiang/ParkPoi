...
<script>
        ...
        map.forEachFeatureAtPixel(evt.pixel, function (feature) {
            if (false === pointFound) {
                ...
                if (p.parkId) {
                    ...
                    message += '<a href="<?php echo $this->Html->url('/admin/issues/add/'); ?>' + p.parkId + '" class="btn btn-default">建立通報</a>';
                    message += '<a href="<?php echo $this->Html->url('/admin/parks/view/'); ?>' + p.parkId + '" class="btn btn-default">檢視公園</a>';
                    message += '</div>';
    ...
    $.getJSON('<?php echo $this->Html->url('/parks/points'); ?>', function (p) {
        var features = [];
        for (k in p) {
